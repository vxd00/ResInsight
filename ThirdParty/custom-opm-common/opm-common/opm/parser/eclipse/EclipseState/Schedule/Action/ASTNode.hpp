...
public:
    ...
    ASTNode(msj_TokenType type_arg, FuncType func_type_arg, const std::string& func_arg, const std::vector<std::string>& arg_list_arg);
    ASTNode(msj_TokenType type_arg, FuncType ftype, const std::string& func_arg,
